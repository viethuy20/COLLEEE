...
<section class="selectedbank">
    <div class="contents__center__box">
        <div class="contents__center__box__text">
            ...
            <p class="small_11 mb_15">受付番号は、交換申請に関するお問い合わせの際GMOポイ活のサポートにて使用いたしますので、正常に交換が完了するまで大切に保管してください。</p>
            <p class="small_11 mb_15">※ギフトコードが届くまで、少々お時間をいただく場合がございます。</p>
        </div>
    </div>
...
<section class="selectedbank">
    <div class="contents__center__box">
        <div class="contents__center__box__text">
            ...
            <p>ポイント交換にあたって交換手数料が発生する交換先の場合、お振込み金額は手数料を差し引いた金額となりますので、ご了承ください。</p>
...
@endif
{{ Tag::link('/support/', '<p class="banks__auth__btn__pink">お客様サポートはこちら</p>', null, null, false) }}
