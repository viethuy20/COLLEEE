        ...
        @csrf
            <table>
                <tr>
                    <th><span>銀行</span></th>
                    <td>
                        <p class="putted">{{ $bank_account->bank->name }}</p>
                    </td>
                </tr>
                <tr>
                    <th><span>支店名</span></th>
                    <td>
                        <p class="putted">{{ $bank_account->bank_branch->name.($bank_account->bank_branch->name == '本店' ? '' : '支店') }}</p>
                    </td>
                </tr>
                <tr>
                    <th><span>口座番号</span></th>
                    <td>
                        <p class="putted">{{ str_repeat('*', strlen($bank_account->number) - 1).substr($bank_account->number, -1) }}</p>
                    </td>
                </tr>
                <tr>
                    <th><span>氏名</span></th>
                    <td>
                        <p class="putted">{{ $bank_account->last_name }}&nbsp;{{ $bank_account->first_name }}</p>
                    </td>
                </tr>
                <tr>
                    <th><span>氏名カナ（口座名義）</span></th>
                    <td>
                        <p class="putted">{{ $bank_account->last_name_kana }}&nbsp;{{ $bank_account->first_name_kana }}</p>
                    </td>
                </tr>
