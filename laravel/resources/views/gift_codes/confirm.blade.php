...
@section('layout.content')
    ...
    <section class="contents">
                    ...
                    <li class="u-mb-10">
                        ...
                        <ol>
                            <li class="u-mb-10">
                                ...
                                メールフィルタなどが作用して迷惑メールフォルダ、ゴミ箱フォルダに入ってしまう場合があります。ギフトコードにつきましては info@colleee.net
                                から配信させていただいております(GMOポイ活にご登録のメールアドレスへ送信されます)。 受信フォルダ以外に info@colleee.net
                                からのメールが届いていないかどうかのご確認をお願いいたします。
                            </li>
                            <li class="u-mb-10">
                                2.受信拒否設定が作用している場合があります。
                                受信拒否設定を特に行っていない場合も、通信会社の迷惑メールフィルタなどが作用してメールが届かない場合がございます。
                                info@colleee.net をドメイン・アドレス指定での受信設定にしていただくと受信可能となります。
                                ギフトコード記載のメールを再送ご希望の場合は、お問い合わせフォームよりGMOポイ活サポートへお問い合わせください。
                            </li>
                        </ol>
                    </li>
                    <li class="u-mb-20">
        ...
        @endif
        <div class="btn_y">{{ Tag::link($exchange_info->url, '戻る') }}</div>
