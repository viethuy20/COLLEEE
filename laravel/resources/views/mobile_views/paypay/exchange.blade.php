...
<ul class="u-mb-15"><li class="u-mb-10 text--14">PayPayは、スマホで利用できるQR決済サービスです。<br>アプリをダウンロード・登録するだけで誰でも無料で使えます。<br>
...
<dl class="caution">
    ...
    <dd><ul class="trademark">
        ...
        <li class="text--14 no-before">PayPay,PayPay.co.jpおよびそれらのロゴはPayPay.Inc.またはその関連会社の商標です。 </li>
    </ul></dd>
</dl>
@endcomponent
@endsection
