...
/**
 * スマートフォン版サイト連携で、ROI から OEM 様ページを呼び出す時の _pf パラメータ一覧
 *
 * @author Kenkichi Mahara
 *
 */
class ROI_Fancrew_SiteCooperation_SmartphonePageFrame {
	/** TOP ページ */
	public static $top;
	 ...
	 *
	 *       http://example.com/fancrew/smartphone.pages?_pf=receipt&_pf.monitor_id=2525
	 *
...
// プロパティ
	 ...
	 * enum 一覧を返す。
	 *
	 * @return ROI_Fancrew_SmartphonePageFrame の array
	 */
	 ...
	 * @return ROI_Fancrew_SmartphonePageFrame オブジェクト。一致するものがなければ null を返す。
	 */
...
// enum 初期化
ROI_Fancrew_SiteCooperation_SmartphonePageFrame::init();
