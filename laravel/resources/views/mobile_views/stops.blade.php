...
@extends('layouts.default')
    ...
    <div class="inner">
        <div class="contents__box u-mt-20">
            <!-- page title -->
            <h2 class="contents__ttl red">不正行為に対して<br>厳正に対処しています！</h2>
    ...
    <!-- 不正行為とは -->
    <div class="inner">
        <div class="contents__box u-pb-remove">
            <h3 class="text--24 red u-font-bold u-text-ac">不正行為とは</h3>
            ...
            <p class="text--18 red u-font-bold u-text-ac u-mt-20"><span class="marker">アカウントおよび</span><br><span class="marker">所持ポイントの抹消を行います。</span></p>
            <p class="text--15 u-text-ac u-mt-small">悪質な不正行為に対しては法的な措置を含めて厳正な対処を実施します。</p>
            <div class="illegal__info">
                <p class="text--18 u-font-bold">GMOポイ活は皆さまの生活を<br>ちょっとお得にできるようサービスを提供していきます。<br>皆様の健全なご利用をお願いいたします。</p>
            </div>
            <div class="illegal__image">
