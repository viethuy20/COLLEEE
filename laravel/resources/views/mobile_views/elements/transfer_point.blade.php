...
<tr>
    ...
    <td>
        <div class="putted_area">
            ...
            <p class="subtraction mb_5"><span id="TransferAmmount"></span>から手数料<span>{{ number_format($charge) }}円</span>を減算致します。</p>
            <div class="total mb_10"><p class="transfer">お振込金額</p><p class="amount" id="TransferAmmountResult"></p></div>
            <p class="error_message"><span class="icon-attention"></span>交換申請ポイントから手数料を減算してのお振込となります。</p>

            <div class="banks__change__btn__pink">
                <button>入力情報の確認</button>
            </div>
            @else
