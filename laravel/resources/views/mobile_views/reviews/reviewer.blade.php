...
<div class="inner u-mt-7">
    @if ($review_total < 1)
        ...
        <div class="revirew__title">
            <h2 class="contents__ttl">{{ $reviewer_name }}さんの口コミ一覧</h2>
            <span>{{ $review_total }}件</span>
        </div>
        <div class="revirew__box">
            <ul>
                <li>
                    ...
                    <br>
                    <p class="revirew__box__txt">参加した広告の口コミを書いてみませんか？</p>
                    <p class="revirew__box__txt">口コミが掲載されると、初回<span>{{ $review_point_management ? $review_point_management->point : 5}}ポイント</span>をプレゼント！</p>
                </li>
