...
require_once APP_CLASS_PATH . 'ROI/Fancrew/SiteCooperation/InvoiceReceiveController.php';
 ...
 * ファンくるの納品書アップロードAPI を呼び出して画像をアップロードします。
 *
 * その後、API から応答 xml の中に含まれる EventMessage を元に、ユーザにメールを返信します。
 */
$controller = new ROI_Fancrew_SiteCooperation_InvoiceReceiveController();
