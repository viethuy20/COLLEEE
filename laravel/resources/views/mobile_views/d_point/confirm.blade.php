...
<section class="selectedbank">
    {{ Tag::formOpen(['url' => route('d_point.store'), 'id' => 'ExchangeForm', 'class' => 'banks__form']) }}
    @csrf    
    <table>
            <tr>
...
<section><div class="btn_y">{{ Tag::link(route('d_point.exchange', ['number' => $exchange['number']]), '戻る') }}</div></section>
