...
@section('url', route('entries.regist'))
...
<div class="contents">
    ...
    @endphp
    <div class="regist__about u-mt-40">
        <div class="regist__about__bnr">
            <a href="{{ $aboutUrl }}">
                {{ Tag::image('/images/regist/regist_bnr.png', 'GMOポイ活ってどんなサービス？') }}
            </a>
        </div>
    </div>
    ...
    @endphp
    <div class="regist__pickup u-mt-40">
    ...
    <ul class="regist__list">
        <li>
            ...
            <dl class="regist__list__chart">
                <dt>プレイ上限</dt>
                <dd>1日3回</dd>
                <dt>獲得時期</dt>
                <dd>1週間</dd>
            </dl>
            <p class="regist__list__txt">毎日3回開催されるクイズ大会に参加してスタンプを集めよう！スタンプはクイズに正解すると獲得でき12個集めると最大2,000ポイントが当たる抽選に参加できるよ！</p>
        </li>
        <li>
            ...
            <p class="regist__list__txt">100種類以上のミニゲームをプレイしてみよう！ゲームを遊んだ結果に応じて「抽選券」を獲得し、100枚貯めると最大1,000ポイントが当たる抽選に参加できるよ！</p>
        </li>
        <li>
            ...
            <p class="regist__list__txt">タイプ入力で無制限にポイントゲット！？デイリーランキング入賞でボーナスも貰える！</p>
        </li>
    </ul>
