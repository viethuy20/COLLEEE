...
@section('layout.content')
    ...
    <div class="contents">
	    <div class="inner u-mt-20">
	    	<h2 class="text--24">メールマガジン受信設定</h2>
	    </div>
        <div class="contents__box">
            <div class="contents__box__inner">
                ...
                <p class="text--15">メールマガジンには、失効ポイントに関する通知メールが含まれます。こちらはメールマガジンの受信をされていない方には配信されません。</p>
                    ...
                    <div class="contents__box__txt">
                        ...
                        <div class="contents__btn__wrap">
                            <div class="contents__btn orange">
                                <button id="submit" type="submit">会員登録を完了する</button>
                            </div>
                        </div>
                {!! Tag::formClose() !!}
            </div>
        </div><!--/contentsbox--><!--/process-->
    </div>
@endsection
