...
<dl class="caution">
    ...
    <dd class="u-mb-10"><ul class="trademark">
        ...
        <li class="text-link no-before text--14">{{ $exchange_info->label }}の詳細は{{ Tag::link(config('url.ntt_waon'), 'こちら', ['target' => '_blank', 'class' => 'external']) }}をご覧ください。</li>
    ...
    <dt>●その他</dt>
    <dd class="u-mb-10"><ul class="trademark">
        <li class="text--14">「{{ $exchange_info->label }}」は、イオンリテール株式会社との発行許諾契約により、株式会社NTTカードソリューションが発行する電子マネーギフトです。</li>
        <li class="text--14">「WAON（ワオン）」は、イオン株式会社の登録商標です。</li>
    </ul></dd>
</dl>
@endcomponent
@endsection
