        ...
        <div class="contents__box">
            <div class="contents__box__inner">
                <div class="contents__box__txt">
                    ...
                    <p>ご登録の電話番号から<strong class="strong">【2分以内】</strong>に「発信認証電話番号」へ発信してください。呼び出し音の後自動的に通話が終了し、認証が完了します。（音声アナウンス等は流れず、発話等の必要はございません）</p>
                </div>
                    ...
                    <div class="entries__form">
                        ...
                        <div class="entries__form__table__head js-limit counter" timestamp="{{ isset($expiresAt) ? Carbon\Carbon::parse($expiresAt)->timestamp : '' }}">残り時間<span class="countDownMin"></span></div>
                            ...
                            <dl class="entries__form__table confirm">
                                <dt><label for="email">発信認証電話番号<br><p class="attention"><strong class="strong">電話番号のおかけ間違いにご注意ください</strong></p></label></dt>
                                <dd class="flex">
                                    <div>
                                        <a class="telnum textlink js-telnum"><i><img src="/images/common/ico_phone.svg"></i>{{ $ost_token->authentic_number }}</a>
                                        <ul class="notes">
                                            <li>通話料金は無料です</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="contents__btn__wrap">
                                <div class="contents__btn orange catch">
                                    <a><span class="catch js-telnum-btn"><i><img src="/images/common/ico_phone.svg"></i></span>電話をかけて認証する</a>
                                </div>
                                <div class="contents__btn">
                                    ...
                                    {{ Tag::formButton('画面が切り替わらない場合はこちら', ['id'=>'entries-auth-tel','class' => 'js-telnum-auth', 'onclick' => "location.href='".url(route('entries.auth_tel'))."'",'disabled' => true]) }}
        ...
        $(function() {
            ...
            setInterval(function() {
                $('.counter').each(function() {
                    ...
                    if(m0 == '00' && s0 == '00'){
                        const entries_auth_tel_bt = document.getElementById('entries-auth-tel');
                        entries_auth_tel_bt.disabled = false;
                        entries_auth_tel_bt.click();
                    }
