...
<ul class="mb_15">
    <li class="mb_10 text-link">Pontaは、いろんなお店でポイントがたまる・つかえる共通ポイントサービスです。</li>
    <br />
    <li class="mb_10 text-link">Pontaポイント コードは、Ponta会員IDにPontaポイントを加算できるサービスです。</li>
    <li class="mb_10 text-link">Pontaポイント コードの詳細は{{ Tag::link(config('url.ponta_about'), 'こちら', ['target' => '_blank', 'class' => 'external']) }}をご覧ください。</li>
</ul>
