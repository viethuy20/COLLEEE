    ...
    <div class="contents__box">
        <div class="contents__box__inner">
            <div class="contents__box__txt">
                <h2 class="contents__ttl"><i><img src="/images/common/ico_check.svg"></i>仮登録メールを送信しました</h2>
                <p><span id="entries-address" class="entries__address">**********{!! '@' !!}{{ $email_domain }}</span>宛に仮登録メールを送信しました。記載されたURLをクリックし、24時間以内に本登録を完了させて下さい。</p>
            </div>
