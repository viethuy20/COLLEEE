...
{!! Tag::style('/css/sp_notes.css') !!}
    ...
    <div class="inner u-mt-20">
        <h2 class="contents__ttl">GMOポイ活の使い方</h2>
    </div>
    ...
    <div class="inner">
        <div class="contents__box u-mt-small" id="step">
            ...
            <div class="guide__step">
                <ul>
                    ...
                    <li>
                        ...
                        <p class="text--15">※サービス詳細ページ「獲得条件・注意事項」を必ずお読みください。</p>
            ...
            <div class="u-mt-40">
                {{ Tag::image('/images/guide/guide_step_img_sp.png') }}
            </div>
            <div class="u-mt-40 u-text-ac">
                <p class="text--15">ポイントが正常に反映されるよう、<br>下記を必ずご確認ください。</p>
    ...
    <div class="inner">
        <div class="contents__box u-mt-small">
            ...
            <div class="guide__example">
                <ul>
                    <li>{{ Tag::image('/images/guide/guide_example1.png" alt="ネットショップでのお買い物') }}</li>
                    <li>{{ Tag::image('/images/guide/guide_example2.png" alt="クレジットカード発行') }}</li>
                    <li>{{ Tag::image('/images/guide/guide_example3.png" alt="ホテルや航空券などの予約') }}</li>
                    <li>{{ Tag::image('/images/guide/guide_example4.png" alt="無料会員登録・セミナーへの参加') }}</li>
                    <li>{{ Tag::image('/images/guide/guide_example5.png" alt="ゲームアプリ') }}</li>
                    <li>{{ Tag::image('/images/guide/guide_example6.png" alt="お友達にGMOポイ活を紹介') }}</li>
                </ul>
            </div>
            <p class="text--15 u-mt-20">などなど、普段の生活がもっとお得になります。<br>
                    ...
                    <li>
                        ...
                        <div class="list">
                            <ul>
                                ...
                                <li>{{ Tag::image('/images/exchanges/img_amazon_txt.png', 'Amazonギフトカード') }}</li>
                                ...
                                <li>{{ Tag::image('/images/exchanges/img_apple_txt.png', 'App Store & iTunes ギフトカード') }}</li>
