...
<section class="selectedbank">
    {{ Tag::formOpen(['url' => route('kdol.store'), 'id' => 'ExchangeForm', 'class' => 'banks__form']) }}
    @csrf    
    <table>
...
<section><div class="btn_y">{{ Tag::link(route('kdol.exchange', ['number' => $exchange['number']]), '戻る') }}</div></section>
