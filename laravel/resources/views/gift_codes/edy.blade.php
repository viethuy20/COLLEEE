...
<dl class="caution">
    ...
    <dd>
        <ul class="trademark">
            <li class="text-link mb_10 no-before text--14">
            ...
            <li class="u-mt-small text--14">{{ $exchange_info->label }}は、店舗等でのお支払いに直接利用することはできません。</li>
            ...
            <li class="text--14">{{ $exchange_info->label }}の登録サイトは、日本国外からのアクセスはできません。</li>
            <li class="u-mt-small text--14">「{{ $exchange_info->label }}」は、楽天Edy株式会社との発行許諾契約により、株式会社NTTカードソリューションが発行する電子マネーギフトサービスです。</li>
