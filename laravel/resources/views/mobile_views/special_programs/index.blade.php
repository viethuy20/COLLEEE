...
<div class="inner">
    <div class="programs_detail__content">
        <div style="float: left;" class="programs_detail__ttl">
            <h1 class="contents__ttl">三井ダイレクト損保の「強くてやさしいクルマの保険」</h1>
        </div>
        <div class="programs_detail__item">
            <div class="programs_detail__item__l">
            ...
            </div><!-- programs_detail__item__l -->
            <div class="programs_detail__item__r">
                <p class="programs_detail__item__txt">新規成約</p>
            </div>
            ...
            <div class="programs_detail__item__b">
                <div class="programs_detail__item__btn">
                    {{ Tag::link($url, 'サービスを利用する', ['onmousedown' => "ga('send', 'event', '【URL】', 'click', 'get_point', {'nonInteraction': 1});", 'class' => 'cvbtn', 'target' => '_blank'], null, false) }}
                </div>
                <dl class="programs_detail__item__chart">
                    <dt>予定反映目安</dt>
                    <dd>即時</dd>
                    <dt>獲得までの期間</dt>
                    <dd>1か月以上</dd>
...
<div class="inner">
    <div class="programs_detail__content">
        <div class="programs_detail__ttl">
            <h3>この広告について</h3>
        </div>
        <div class="programs_detail__item">
            <div class="programs_detail__item__txt">
...
<div class="inner">
    <div class="programs_detail__content">
        ...
        <div class="programs_detail__item">
            ...
            <p class="programs_detail__item__txt">
