...
<div class="inner u-mt-20">
    <h2 class="contents__ttl">
        {{ Tag::image('/images/about/about_ttl.png', 'GMOポイ活ってどんなサービス？') }}
    </h2>
</div>
...
<div class="inner">
    <div class="contents__box u-mt-20">
        ...
        <div class="about__point u-mt-20">
            <ul>
                <li>
                    <div class="num">1</div>
        ...
        <h3 class="about__ttl u-mt-20">ポイントを貯めよう！</h3>
        ...
        <div class="about__exchange">
            <ul>
                ...
                <li><img src="/images/exchanges/img_amazon_txt.png" alt="Amazonギフトカード"></li>
                ...
                <li><img src="/images/exchanges/img_apple_txt.png" alt="App Store &amp; iTunes ギフトカード"></li>
    ...
    <div class="contents__box u-mt-20">
        ...
        <p class="text--15">入力されたメールアドレスに、無料会員登録のご案内メールが届きます。</p>
            <div class="u-mt-small">
                {!! Tag::formText('email', '', ['placeholder' => 'メールアドレスを入力してください', 'class' => 'address', 'required' => 'required']) !!}
            </div>
            @if ($errors->has('email'))
            <!--エラーの場合はここに-->
        ...
        <textarea class="contentTerm" name="content" rows="10" id="contentTerm" disabled>{{ config('text.about_handing_of_personal_information') }}</textarea>
            ...
            <div class="about_form__privacy u-mt-20">
                <p>入力・送信頂いた個人情報は、{!! Tag::link(config('url.gmo_nikko'), 'GMO NIKKO株式会社', ['target' => '_blank', 'class' => 'external']) !!}が適切に管理し、「個人情報の取扱いについて」に記載する利用目的の範囲内で利用いたします。</p>
            </div>
            @php
            ...
            if (isset($referer)) {
             ...
             $urlLine = $lineService->getLoginBaseUrl();
            @endphp
            <p class="text--15 u-font-bold u-text-ac u-mt-20">すでに会員の方</p>
            <div class="about_form__btn__login u-mt-small">
...
@endphp
<div class="about__pickup u-mt-20">
