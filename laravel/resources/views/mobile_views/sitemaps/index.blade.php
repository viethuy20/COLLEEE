...
<section class="sitemap">
    <h1 class="contents__ttl u-mt-20">サイトマップ</h1>
    ...
    <div class="contents__box u-mt-20 text--16">
        ...
        <ul>
            ...
            <li><span class="icon-arrowr"></span>&nbsp;{!! Tag::link(route('credit_cards.index'), 'カード比較') !!}</li>
        ...
        <ul>
            ...
            <li><span class="icon-arrowr"></span>&nbsp;{!! Tag::link(config('url.gmo_nikko'), '運営会社', ['target' => '_blank', 'class' => 'lnk_external']) !!}</li>
            <li><span class="icon-arrowr"></span>&nbsp;{!! Tag::link(route('abouts.membership_contract'), '利用規約') !!}</li>
            <li><span class="icon-arrowr"></span>&nbsp;{!! Tag::link(config('url.privacy_policy'), '個人情報保護方針', ['target' => '_blank', 'class' => 'lnk_external']) !!}</li>
